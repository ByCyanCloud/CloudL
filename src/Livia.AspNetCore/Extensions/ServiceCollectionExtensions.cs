...
using Livia.AspNetCore.Json;
using Livia.AspNetCore.Logging;
...
namespace Livia.AspNetCore.Extensions;

/// <summary>
/// Livia.AspNetCore 的依赖注入入口。
/// </summary>
public static class ServiceCollectionExtensions
{
    ...
    /// </remarks>
    public static IServiceCollection AddLiviaAspNetCore(
        ...
        IConfiguration configuration)
    {
        ...
        AddLiviaHttpClients(services, configuration);
        services.AddLiviaJwtAuthentication();
        services.AddLiviaCors(configuration);
    ...
    /// </summary>
    public static IMvcBuilder AddLiviaJsonOptions(this IMvcBuilder builder)
    {
        ArgumentNullException.ThrowIfNull(builder);

        builder.AddJsonOptions(options =>
        {
            var source = LiviaJson.SerializerOptions;
    ...
    /// </summary>
    public static IServiceCollection AddLiviaJwtAuthentication(this IServiceCollection services)
    {
        ArgumentNullException.ThrowIfNull(services);
    ...
    /// </summary>
    public static IServiceCollection AddLiviaCors(
        this IServiceCollection services,
        IConfiguration configuration)
    {
        ArgumentNullException.ThrowIfNull(services);
    ...
    public static IServiceCollection AddLiviaSwagger(
        this IServiceCollection services,
        string title = "Livia API",
        params Assembly[] xmlDocumentAssemblies)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            options.SwaggerDoc("v1", new OpenApiInfo
            {
                Title = title,
                Version = "v1",
                Description = "由 Livia DDD 框架生成的 API 文档"
            });
    ...
    /// </summary>
    public static WebApplication UseLiviaSwagger(
    ...
    private static void AddLiviaHttpClients(IServiceCollection services, IConfiguration configuration)
    {
        ...
        string message)
    {
        ...
        await httpContext.Response
            .WriteAsync(LiviaJson.Serialize(ApiResponse.Fail(businessCode, message)))
